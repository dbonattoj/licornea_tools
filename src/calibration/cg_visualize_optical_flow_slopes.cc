...
int main(int argc, const char* argv[]) {
	get_args(argc, argv,
		"dataset_parameters.json intrinsics.json slopes.json out_visualization.png [width=200] [exaggeration=1] [dataset_group]");
	...
	img = visualize_feature_slopes(fslopes, img, width, exaggeration, 2, bord);
